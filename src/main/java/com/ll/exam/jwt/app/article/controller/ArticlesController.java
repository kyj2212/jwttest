...
public class ArticlesController {
    ...
    @DeleteMapping("{id}")
    public ResponseEntity<ResultResponse> delete(@PathVariable Long id, @AuthenticationPrincipal MemberContext memberContext) {
        Article article = articleService.findById(id).orElse(null);
    ...
    @PatchMapping("{id}")
    public ResponseEntity<ResultResponse> modify(@PathVariable Long id, @AuthenticationPrincipal MemberContext memberContext, @Valid @RequestBody ArticleModifyDto articleModifyDto) {
        Article article = articleService.findById(id).orElse(null);
